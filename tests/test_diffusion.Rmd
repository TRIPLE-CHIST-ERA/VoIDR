...
cat(get_sparql_prefixes(prefixes))
...
")
cat(query_node_taxo)
node_taxo <- sparql_query(endpoint_url, query_node_taxo, prefixes = prefixes)
node_taxo
...
edge_taxo <- sparql_query(endpoint_url, query_edge_taxo, prefixes = prefixes)
edge_taxo
...
")
value_taxo <- sparql_query(endpoint_url, query_value_taxo, prefixes = prefixes)
value_taxo
